 ...
 //   Seekers
  ...
  //  Weather
    ...
    public void SetLineUp(SeasonTeam visitor, SeasonTeam home)
    {
        ...
        team1ChasersIntercept[0] = visitor.chasers[0].intercept + visitor.chasers[0].hat.Intercept + visitor.chasers[0].gloves.Intercept + visitor.chasers[0].glasses.Intercept + visitor.chasers[0].body.Intercept + visitor.chasers[0].broom.Intercept + visitor.teamStrategy.intercept;
        team1ChasersIntercept[1] = visitor.chasers[1].intercept + visitor.chasers[1].hat.Intercept + visitor.chasers[1].gloves.Intercept + visitor.chasers[1].glasses.Intercept + visitor.chasers[1].body.Intercept + visitor.chasers[1].broom.Intercept + visitor.teamStrategy.intercept;
        team1ChasersIntercept[2] = visitor.chasers[2].intercept + visitor.chasers[2].hat.Intercept + visitor.chasers[2].gloves.Intercept + visitor.chasers[2].glasses.Intercept + visitor.chasers[2].body.Intercept + visitor.chasers[2].broom.Intercept + visitor.teamStrategy.intercept;
        team1ChasersPass[0] = visitor.chasers[0].pass + visitor.chasers[0].hat.Pass + visitor.chasers[0].gloves.Pass + visitor.chasers[0].glasses.Pass + visitor.chasers[0].body.Pass + visitor.chasers[0].broom.Pass + visitor.teamStrategy.passing;
        team1ChasersPass[1] = visitor.chasers[1].pass + visitor.chasers[1].hat.Pass + visitor.chasers[1].gloves.Pass + visitor.chasers[1].glasses.Pass + visitor.chasers[1].body.Pass + visitor.chasers[1].broom.Pass + visitor.teamStrategy.passing;
        team1ChasersPass[2] = visitor.chasers[2].pass + visitor.chasers[2].hat.Pass + visitor.chasers[2].gloves.Pass + visitor.chasers[2].glasses.Pass + visitor.chasers[2].body.Pass + visitor.chasers[2].broom.Pass + visitor.teamStrategy.passing;
        team1ChaserTackle[0] = visitor.chasers[0].tackle + visitor.chasers[0].hat.Tackle + visitor.chasers[0].gloves.Tackle + visitor.chasers[0].glasses.Tackle + visitor.chasers[0].body.Tackle + visitor.chasers[0].broom.Tackle + visitor.teamStrategy.tackle;
        team1ChaserTackle[1] = visitor.chasers[1].tackle + visitor.chasers[1].hat.Tackle + visitor.chasers[1].gloves.Tackle + visitor.chasers[1].glasses.Tackle + visitor.chasers[1].body.Tackle + visitor.chasers[1].broom.Tackle + visitor.teamStrategy.tackle;
        team1ChaserTackle[2] = visitor.chasers[2].tackle + visitor.chasers[2].hat.Tackle + visitor.chasers[2].gloves.Tackle + visitor.chasers[2].glasses.Tackle + visitor.chasers[2].body.Tackle + visitor.chasers[2].broom.Tackle + visitor.teamStrategy.tackle;
        team1ChaserShooting[0] = visitor.chasers[0].shooting + visitor.chasers[0].hat.Shooting + visitor.chasers[0].gloves.Shooting + visitor.chasers[0].glasses.Shooting + visitor.chasers[0].body.Shooting + visitor.chasers[0].broom.Shooting + visitor.teamStrategy.shooting;
        team1ChaserShooting[1] = visitor.chasers[1].shooting + visitor.chasers[1].hat.Shooting + visitor.chasers[1].gloves.Shooting + visitor.chasers[1].glasses.Shooting + visitor.chasers[1].body.Shooting + visitor.chasers[1].broom.Shooting + visitor.teamStrategy.shooting;
        team1ChaserShooting[2] = visitor.chasers[2].shooting + visitor.chasers[2].hat.Shooting + visitor.chasers[2].gloves.Shooting + visitor.chasers[2].glasses.Shooting + visitor.chasers[2].body.Shooting + visitor.chasers[2].broom.Shooting + visitor.teamStrategy.shooting;
        team1ChaserDodge[0] = visitor.chasers[0].dodge + visitor.chasers[0].hat.Dodge + visitor.chasers[0].gloves.Dodge + visitor.chasers[0].glasses.Dodge + visitor.chasers[0].body.Dodge + visitor.chasers[0].broom.Dodge + visitor.teamStrategy.dodge;
        team1ChaserDodge[1] = visitor.chasers[1].dodge + visitor.chasers[1].hat.Dodge + visitor.chasers[1].gloves.Dodge + visitor.chasers[1].glasses.Dodge + visitor.chasers[1].body.Dodge + visitor.chasers[1].broom.Dodge + visitor.teamStrategy.dodge;
        team1ChaserDodge[2] = visitor.chasers[2].dodge + visitor.chasers[2].hat.Dodge + visitor.chasers[2].gloves.Dodge + visitor.chasers[2].glasses.Dodge + visitor.chasers[2].body.Dodge + visitor.chasers[2].broom.Dodge + visitor.teamStrategy.dodge;
        team1ChaserSpeed[0] = visitor.chasers[0].speed + visitor.chasers[0].hat.Speed + visitor.chasers[0].gloves.Speed + visitor.chasers[0].glasses.Speed + visitor.chasers[0].body.Speed + visitor.chasers[0].broom.Speed + visitor.teamStrategy.dodge;
        team1ChaserSpeed[1] = visitor.chasers[1].speed + visitor.chasers[1].hat.Speed + visitor.chasers[1].gloves.Speed + visitor.chasers[1].glasses.Speed + visitor.chasers[1].body.Speed + visitor.chasers[1].broom.Speed + visitor.teamStrategy.dodge;
        team1ChaserSpeed[2] = visitor.chasers[2].speed + visitor.chasers[2].hat.Speed + visitor.chasers[2].gloves.Speed + visitor.chasers[2].glasses.Speed + visitor.chasers[2].body.Speed + visitor.chasers[2].broom.Speed + visitor.teamStrategy.dodge;

        team1Beaters[0] = visitor.beaters[0].Name;
        team1Beaters[1] = visitor.beaters[1].Name;
        team1BeaterLocateBludgerSpeed[0] = visitor.beaters[0].locateSpeed + visitor.beaters[0].hat.LocateSpeed + visitor.beaters[0].gloves.LocateSpeed + visitor.beaters[0].glasses.LocateSpeed + visitor.beaters[0].body.LocateSpeed + visitor.beaters[0].broom.LocateSpeed + visitor.teamStrategy.locateSpeed;
        team1BeaterLocateBludgerSpeed[1] = visitor.beaters[1].locateSpeed + visitor.beaters[1].hat.LocateSpeed + visitor.beaters[1].gloves.LocateSpeed + visitor.beaters[1].glasses.LocateSpeed + visitor.beaters[1].body.LocateSpeed + visitor.beaters[1].broom.LocateSpeed + visitor.teamStrategy.locateSpeed;
        team1BeaterDodge[0] = visitor.beaters[0].dodge + visitor.beaters[0].hat.Dodge + visitor.beaters[0].gloves.Dodge + visitor.beaters[0].glasses.Dodge + visitor.beaters[0].body.Dodge + visitor.beaters[0].broom.Dodge + visitor.teamStrategy.dodge;
        team1BeaterDodge[1] = visitor.beaters[1].dodge + visitor.beaters[1].hat.Dodge + visitor.beaters[1].gloves.Dodge + visitor.beaters[1].glasses.Dodge + visitor.beaters[1].body.Dodge + visitor.beaters[1].broom.Dodge + visitor.teamStrategy.dodge;

        team1Keeper = visitor.keeper[0].Name;
        team1KeeperDodge = visitor.keeper[0].dodge + visitor.keeper[0].hat.Dodge + visitor.keeper[0].gloves.Dodge + visitor.keeper[0].glasses.Dodge + visitor.keeper[0].body.Dodge + visitor.keeper[0].broom.Dodge + visitor.teamStrategy.dodge;
        team1KeeperBlock = visitor.keeper[0].block + visitor.keeper[0].hat.Block + visitor.keeper[0].gloves.Block + visitor.keeper[0].glasses.Block + visitor.keeper[0].body.Block + visitor.keeper[0].broom.Block + visitor.teamStrategy.block;

        team1Seeker = visitor.seeker[0].Name;
        team1SeekerDodge = visitor.seeker[0].dodge + visitor.seeker[0].hat.Dodge + visitor.seeker[0].gloves.Dodge + visitor.seeker[0].glasses.Dodge + visitor.seeker[0].body.Dodge + visitor.seeker[0].broom.Dodge + visitor.teamStrategy.dodge;
        team1SeekerSight = visitor.seeker[0].sight + visitor.seeker[0].hat.Sight + visitor.seeker[0].gloves.Sight + visitor.seeker[0].glasses.Sight + visitor.seeker[0].body.Sight + visitor.seeker[0].broom.Sight + visitor.teamStrategy.sight;
        team1SeekerSpeed = visitor.seeker[0].speed + visitor.seeker[0].hat.Speed + visitor.seeker[0].gloves.Speed + visitor.seeker[0].glasses.Speed + visitor.seeker[0].body.Speed + visitor.seeker[0].broom.Speed + visitor.teamStrategy.speed;
        team1SeekerReach = visitor.seeker[0].reach + visitor.seeker[0].hat.Reach + visitor.seeker[0].gloves.Reach + visitor.seeker[0].glasses.Reach + visitor.seeker[0].body.Reach + visitor.seeker[0].broom.Reach + visitor.teamStrategy.reach;
        team1SeekerGrabRange = visitor.seeker[0].grab + visitor.seeker[0].hat.Grab + visitor.seeker[0].gloves.Grab + visitor.seeker[0].glasses.Grab + visitor.seeker[0].body.Grab + visitor.seeker[0].broom.Grab + visitor.teamStrategy.grab;
        ...
        if (home != null)
        {
            ...
            team2ChasersIntercept[0] = home.chasers[0].intercept + home.chasers[0].hat.Intercept + home.chasers[0].gloves.Intercept + home.chasers[0].glasses.Intercept + home.chasers[0].body.Intercept + home.chasers[0].broom.Intercept + home.teamStrategy.intercept;
            team2ChasersIntercept[1] = home.chasers[1].intercept + home.chasers[1].hat.Intercept + home.chasers[1].gloves.Intercept + home.chasers[1].glasses.Intercept + home.chasers[1].body.Intercept + home.chasers[1].broom.Intercept + home.teamStrategy.intercept;
            team2ChasersIntercept[2] = home.chasers[2].intercept + home.chasers[2].hat.Intercept + home.chasers[2].gloves.Intercept + home.chasers[2].glasses.Intercept + home.chasers[2].body.Intercept + home.chasers[2].broom.Intercept + home.teamStrategy.intercept;
            team2ChasersPass[0] = home.chasers[0].pass + home.chasers[0].hat.Pass + home.chasers[0].gloves.Pass + home.chasers[0].glasses.Pass + home.chasers[0].body.Pass + home.chasers[0].broom.Pass + home.teamStrategy.passing;
            team2ChasersPass[1] = home.chasers[1].pass + home.chasers[1].hat.Pass + home.chasers[1].gloves.Pass + home.chasers[1].glasses.Pass + home.chasers[1].body.Pass + home.chasers[1].broom.Pass + home.teamStrategy.passing;
            team2ChasersPass[2] = home.chasers[2].pass + home.chasers[2].hat.Pass + home.chasers[2].gloves.Pass + home.chasers[2].glasses.Pass + home.chasers[2].body.Pass + home.chasers[2].broom.Pass + home.teamStrategy.passing;
            team2ChaserTackle[0] = home.chasers[0].tackle + home.chasers[0].hat.Tackle + home.chasers[0].gloves.Tackle + home.chasers[0].glasses.Tackle + home.chasers[0].body.Tackle + home.chasers[0].broom.Tackle + home.teamStrategy.tackle;
            team2ChaserTackle[1] = home.chasers[1].tackle + home.chasers[1].hat.Tackle + home.chasers[1].gloves.Tackle + home.chasers[1].glasses.Tackle + home.chasers[1].body.Tackle + home.chasers[1].broom.Tackle + home.teamStrategy.tackle;
            team2ChaserTackle[2] = home.chasers[2].tackle + home.chasers[2].hat.Tackle + home.chasers[2].gloves.Tackle + home.chasers[2].glasses.Tackle + home.chasers[2].body.Tackle + home.chasers[2].broom.Tackle + home.teamStrategy.tackle;
            team2ChaserShooting[0] = home.chasers[0].shooting + home.chasers[0].hat.Shooting + home.chasers[0].gloves.Shooting + home.chasers[0].glasses.Shooting + home.chasers[0].body.Shooting + home.chasers[0].broom.Shooting + home.teamStrategy.shooting;
            team2ChaserShooting[1] = home.chasers[1].shooting + home.chasers[1].hat.Shooting + home.chasers[1].gloves.Shooting + home.chasers[1].glasses.Shooting + home.chasers[1].body.Shooting + home.chasers[1].broom.Shooting + home.teamStrategy.shooting;
            team2ChaserShooting[2] = home.chasers[2].shooting + home.chasers[2].hat.Shooting + home.chasers[2].gloves.Shooting + home.chasers[2].glasses.Shooting + home.chasers[2].body.Shooting + home.chasers[2].broom.Shooting + home.teamStrategy.shooting;
            team2ChaserDodge[0] = home.chasers[0].dodge + home.chasers[0].hat.Dodge + home.chasers[0].gloves.Dodge + home.chasers[0].glasses.Dodge + home.chasers[0].body.Dodge + home.chasers[0].broom.Dodge + home.teamStrategy.dodge;
            team2ChaserDodge[1] = home.chasers[1].dodge + home.chasers[1].hat.Dodge + home.chasers[1].gloves.Dodge + home.chasers[1].glasses.Dodge + home.chasers[1].body.Dodge + home.chasers[1].broom.Dodge + home.teamStrategy.dodge;
            team2ChaserDodge[2] = home.chasers[2].dodge + home.chasers[2].hat.Dodge + home.chasers[2].gloves.Dodge + home.chasers[2].glasses.Dodge + home.chasers[2].body.Dodge + home.chasers[2].broom.Dodge + home.teamStrategy.dodge;
            team2ChaserSpeed[0] = home.chasers[0].speed + home.chasers[0].hat.Speed + home.chasers[0].gloves.Speed + home.chasers[0].glasses.Speed + home.chasers[0].body.Speed + home.chasers[0].broom.Speed + home.teamStrategy.dodge;
            team2ChaserSpeed[1] = home.chasers[1].speed + home.chasers[1].hat.Speed + home.chasers[1].gloves.Speed + home.chasers[1].glasses.Speed + home.chasers[1].body.Speed + home.chasers[1].broom.Speed + home.teamStrategy.dodge;
            team2ChaserSpeed[2] = home.chasers[2].speed + home.chasers[2].hat.Speed + home.chasers[2].gloves.Speed + home.chasers[2].glasses.Speed + home.chasers[2].body.Speed + home.chasers[2].broom.Speed + home.teamStrategy.dodge;

            team2Beaters[0] = home.beaters[0].Name;
            team2Beaters[1] = home.beaters[1].Name;
            team2BeaterLocateBludgerSpeed[0] = home.beaters[0].locateSpeed + home.beaters[0].hat.LocateSpeed + home.beaters[0].gloves.LocateSpeed + home.beaters[0].glasses.LocateSpeed + home.beaters[0].body.LocateSpeed + home.beaters[0].broom.LocateSpeed + home.teamStrategy.locateSpeed;
            team2BeaterLocateBludgerSpeed[1] = home.beaters[1].locateSpeed + home.beaters[1].hat.LocateSpeed + home.beaters[1].gloves.LocateSpeed + home.beaters[1].glasses.LocateSpeed + home.beaters[1].body.LocateSpeed + home.beaters[1].broom.LocateSpeed + home.teamStrategy.locateSpeed;
            team2BeaterDodge[0] = home.beaters[0].dodge + home.beaters[0].hat.Dodge + home.beaters[0].gloves.Dodge + home.beaters[0].glasses.Dodge + home.beaters[0].body.Dodge + home.beaters[0].broom.Dodge + home.teamStrategy.dodge;
            team2BeaterDodge[1] = home.beaters[1].dodge + home.beaters[1].hat.Dodge + home.beaters[1].gloves.Dodge + home.beaters[1].glasses.Dodge + home.beaters[1].body.Dodge + home.beaters[1].broom.Dodge + home.teamStrategy.dodge;

            team2Keeper = home.keeper[0].Name;
            team2KeeperDodge = home.keeper[0].dodge + home.keeper[0].hat.Dodge + home.keeper[0].gloves.Dodge + home.keeper[0].glasses.Dodge + home.keeper[0].body.Dodge + home.keeper[0].broom.Dodge + home.teamStrategy.dodge;
            team2KeeperBlock = home.keeper[0].block + home.keeper[0].hat.Block + home.keeper[0].gloves.Block + home.keeper[0].glasses.Block + home.keeper[0].body.Block + home.keeper[0].broom.Block + home.teamStrategy.block;

            team2Seeker = home.seeker[0].Name;
            team2SeekerDodge = home.seeker[0].dodge + home.seeker[0].hat.Dodge + home.seeker[0].gloves.Dodge + home.seeker[0].glasses.Dodge + home.seeker[0].body.Dodge + home.seeker[0].broom.Dodge + home.teamStrategy.dodge;
            team2SeekerSight = home.seeker[0].sight + home.seeker[0].hat.Sight + home.seeker[0].gloves.Sight + home.seeker[0].glasses.Sight + home.seeker[0].body.Sight + home.seeker[0].broom.Sight + home.teamStrategy.sight;
            team2SeekerSpeed = home.seeker[0].speed + home.seeker[0].hat.Speed + home.seeker[0].gloves.Speed + home.seeker[0].glasses.Speed + home.seeker[0].body.Speed + home.seeker[0].broom.Speed + home.teamStrategy.speed;
            team2SeekerReach = home.seeker[0].reach + home.seeker[0].hat.Reach + home.seeker[0].gloves.Reach + home.seeker[0].glasses.Reach + home.seeker[0].body.Reach + home.seeker[0].broom.Reach + home.teamStrategy.reach;
            team2SeekerGrabRange = home.seeker[0].grab + home.seeker[0].hat.Grab + home.seeker[0].gloves.Grab + home.seeker[0].glasses.Grab + home.seeker[0].body.Grab + home.seeker[0].broom.Grab + home.teamStrategy.grab;
